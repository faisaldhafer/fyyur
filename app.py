...
def search_venues():
  ...
  venue_list = list(map({'id':Venue.id, 'name':Venue.name}, venue_query))
  response = {
...
def show_venue(venue_id):
  ...
  if venue_query:
      data = Venue.venInfo(venue_query)
...
def edit_artist(artist_id):
  ...
  artist_d = Artist.query.get(artist_id)
  form.name.data = artist_d.name
  form.genres.data = artist_d.genres
  form.city.data = artist_d.city
  form.state.data = artist_d.state
  form.phone.data = artist_d.phone
  form.website.data = artist_d.website
  form.facebook_link.data = artist_d.facebook_link
  form.image_link.data = artist_d.image_link
